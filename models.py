...
class Graph(object):
    ...
    def create_conv1d_model(self):
      fingerprint_3d = tf.reshape(self.fingerprint_input,
                                  [-1, self.fingerprint_size, 1])  # [batch, in_width, in_channels]

      # conv blocks
      block_1 = stacked_conv_pooling(fingerprint_3d, 80, 4, 64, 1, self.is_training, self.dropout_prob, 'block_1',
                                     'max', 4)
    ...
    def create_residual_conv1d(self):
      ...
      block_1 = stacked_conv_pooling(fingerprint_3d, 80, 4, 48, 1, self.is_training, self.dropout_prob, 'block_1',
                                     'max', 4)
      ...
      res_block_1_3 = residual_block_1d(res_block_1_2, 3, 1, 48, self.is_training, self.dropout_prob, 'res_block_1_3',
      ...
      res_block_2_4 = residual_block_1d(res_block_2_3, 3, 1, 96, self.is_training, self.dropout_prob, 'res_block_2_4',
                                        pooling_type='avg', pooling_size=4)
